...
I build **production AI systems**, from model development and evaluation to deployment and monitoring. 10+ years across applied Machine Learning, Deep Learning, Computer Vision, and Generative AI.

- **Generative AI:** RAG, GraphRAG, Knowledge Graphs, agentic workflows, MCP, LLM evaluation, information extraction, and fine-tuning.
- **Machine Learning:** PyTorch, TensorFlow, scikit-learn, model training, evaluation, optimization, and production ML pipelines.
- **Computer Vision:** 3D reconstruction, scene understanding, pose estimation, motion forecasting, and multimodal systems.
- **ML Engineering:** Docker, MLflow, CI/CD, cloud deployment, monitoring, APIs, and scalable data pipelines.

**Selected impact:**
- Reduced production service costs by 50%+ via model profiling and cost-analysis pipelines
- Improved multi-label classification F1 from 55% → 70% by redesigning the training/data pipeline
- Built a knowledge-graph + LLM entity-linking pipeline running over 38M+ production records
- Published at WACV 2024, VISAPP (oral), WSCG — human motion forecasting & adversarial robustness

### 🏭 Domains

Finance · Compliance · Manufacturing · Automotive · Industrial AI

📫 [Email](mailto:edgarmedina1801@gmail.com) · [LinkedIn](https://www.linkedin.com/in/emedinac/) · [Google Scholar](https://scholar.google.com/citations?user=0K9sZC0AAAAJ&hl)
...
<a href="mailto:edgarmedina1801@gmail.com"><img align="left" alt="Gmail" width="22px" src="https://upload.wikimedia.org/wikipedia/commons/7/7e/Gmail_icon_(2020).svg" /></a>
<a href="https://www.linkedin.com/in/emedinac/"><img align="left" alt="Linkedin" width="22px" src="https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png" /></a>
<br />
